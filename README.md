...
python3 src/turtlebot4_rl/turtlebot4_rl/rl_node.py --algorithm SAC --model_path models/SAC/SAC_20260122_193153_FINAL_10000000steps.zip --eval_only --episodes 10
```